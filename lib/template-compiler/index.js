...
var compiler = require('vue-template-compiler-reverse-trace')
...
module.exports = function (html) {
  ...
  var compilerOptions = {
    ...
    scopedId: options.id,
    __component_path : options.__component_path,
    injectPathTemplateRootElement : options.injectPathTemplateRootElement,
  }
